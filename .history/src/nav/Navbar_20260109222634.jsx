...
<TiThMenu  onClick={()=>setOpenmenu(!openmenu)}  style={{width:"50px",height:"30px", marginTop:"5%", }}/>
   ...
   {openmenu? <div style={{position:"absolute",width:"90%",background:"black", height:"600px", zIndex:"999", marginTop:"10%", borderRadius:"19px", right:"0"}}>
<ImCross style={{ color:"red", left:"0", justifyContent:"flex-start", width:"50px", height:"20px"}}/>
   </div>: null}
    </div>
  )
}
